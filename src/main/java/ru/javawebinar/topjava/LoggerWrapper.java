...
public class LoggerWrapper {
    ...
    private LoggerWrapper(Logger logger) {this.logger = logger;}
    ...
    public IllegalStateException getIllegalStateException(String msg){return getIllegalStateException(msg, null);}
